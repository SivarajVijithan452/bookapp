...
function Navbar() {
    ...
    return (
        <nav className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 right-0 left-0 z-50 ${
            ...
            <div className="navbar">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-xl font-bold cursor-pointer">Globel Book Store</a>
                </div>
                <div className='navbar-end space-x-3'>
                    ...
                    </div>
                    {
                        authUser? (<Logout />):(
                        <div className="">
                        <a className="bg-black text-white p-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={openModal}>Login</a>
                        <Login />
                    </div>
                    )}
